...
```{r k_syn_plot}
high_ksyn_response <- response_func(k_syn=base_ab_k_syn*2, k_deg=base_ab_k_deg,
                                k_eRL=base_ab_k_eRL, k_on=base_ab_k_on,
                                k_off=base_ab_k_off,
                                L_start=base_ab_L_start,
                                L_end=base_ab_L_end)
...
ksyn_plot <- ggplot(ksyn_response,aes(x=ligand_conc, y=response, col=k_syn_factor)) +
  ...
  geom_vline(data=ksyn_response,
             mapping=aes(xintercept= EC_50, col=k_syn_factor), lty=2) +
  scale_x_log10() +
  geom_line() +
  ...
  xlab("Ligand concentration [uM]") + ylab("Respones [A.U.]")
print(ksyn_plot)
```

```{r k_deg}
high_kdeg_response <- response_func(k_syn=base_ab_k_syn, k_deg=base_ab_k_deg*2,
                                k_eRL=base_ab_k_eRL, k_on=base_ab_k_on,
                                k_off=base_ab_k_off,
                                L_start=base_ab_L_start,
                                L_end=base_ab_L_end)
low_kdeg_response <- response_func(k_syn=base_ab_k_syn, k_deg=base_ab_k_deg*0.5,
                                k_eRL=base_ab_k_eRL, k_on=base_ab_k_on,
                                k_off=base_ab_k_off,
                                L_start=base_ab_L_start,
                                L_end=base_ab_L_end)
...
kdeg_plot <- ggplot(kdeg_response,aes(x=ligand_conc, y=response, col=k_deg_factor)) +
  ...
  geom_vline(data=kdeg_response,
             mapping=aes(xintercept= EC_50, col=k_deg_factor), lty=2) +
  scale_x_log10() +
  geom_line() +
   theme(legend.position = "top", 
        legend.text = element_text(size=14),
...
high_kdeg_ksyn_response <- response_func(k_syn=base_ab_k_syn*2, k_deg=base_ab_k_deg*2,
                                ...
                                L_start=base_ab_L_start,
                                L_end=base_ab_L_end)
low_kdeg_ksyn_response <- response_func(k_syn=base_ab_k_syn*0.5, k_deg=base_ab_k_deg*0.5,
                                k_eRL=base_ab_k_eRL, k_on=base_ab_k_on,
                                k_off=base_ab_k_off,
                                L_start=base_ab_L_start,
                                L_end=base_ab_L_end)
...
grid.arrange(ksyn_plot+ylim(0, 65), 
             kdeg_plot+ylim(0, 65),
             kdeg_ksyn_plot+ylim(0, 65), 
             keRL_plot+ylim(0, 65),
             nrow=2)
```
