...
p_homeo <- k_syn/k_deg # asymptotic steady-state (homeostasis) level
...
$$
R_{ss} = \frac{k_{syn}}{k_{deg}}\frac{EC_{50}}{L_{ss} + EC_{50}} = R_0 \cdot (1-\frac{L_{ss}}{L_{ss}+ EC_{50}}) \\
RL_{ss} = \frac{k_{syn}}{k_{e(RL)}}\frac{L_{ss}}{L_{ss}+ EC_{50}} = R_0 \cdot \frac{k_{deg}}{k_{e(RL)}} \cdot \frac{L_{ss}}{L_{ss}+ EC_{50}}  \\
EC_{50} = \frac{}
$$
