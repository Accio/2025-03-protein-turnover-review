...
```{r}
response_func <- function(k_syn=2E7, k_deg=1E-9, k_eRL=1E-9,
...
```{r k_syn_plot}
high_ksyn_response <- response_func(k_syn=base_k_syn*1.05)
low_ksyn_response <- response_func(k_syn=base_k_syn*0.95)
...
```{r k_deg}
high_kdeg_response <- response_func(k_deg=base_k_deg*10)
low_kdeg_response <- response_func(k_deg=base_k_deg*.1)
...
```{r k_eRL}
high_keRL_response <- response_func(k_eRL=base_k_eRL*2)
low_keRL_response <- response_func(k_eRL=base_k_eRL*.5)
