...
```{r homeostasis_plot, fig.height=4, fig.width=5}
...
##           label=expression(paste("Degradation rate ", k[deg])), size=4, hjust=0, vjust=0) +
  ...
  annotate("text", x=17, y=p_homeo*1.12, col=total_prot_col, size=6,
           label=expression(paste("Total abundance=", frac(k[syn],k[deg])))) +
  empty_theme +
