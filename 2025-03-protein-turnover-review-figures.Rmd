...
ksyn_plot <- ggplot(ksyn_response,aes(x=ligand_conc, y=response, 
  ...
  annotate("text", x=1E-4, y=48, vjust=0.5, hjust=0, size=5,
...
kdeg_plot <- ggplot(kdeg_response,aes(x=ligand_conc, y=response, 
  ...
  #              arrow = arrow(length = unit(0.03, "npc"))) +
  annotate("text",  x=1E-4,, y=36, vjust=0, hjust=0, size=5,
...
kdeg_ksyn_plot <- ggplot(kdeg_ksyn_response,aes(x=ligand_conc, y=response, 
  ...
  #              col="black", inherit.aes = FALSE, 
  #              arrow = arrow(length = unit(0.03, "npc"))) +
  annotate("text",  x=1E-4,, y=58, vjust=0, hjust=0, size=5,
...
keRL_plot <- ggplot(keRL_response,aes(x=ligand_conc, y=response, 
  ...
  #              col="black", inherit.aes = FALSE, 
  #              arrow = arrow(length = unit(0.03, "npc"))) +
  annotate("text", x=1E-4, y=60, vjust=0, hjust=0, size=5,
...
rev_irrev_plot <- ggplot(rev_irrev_response,
  ...
  annotate("text", 
           x=rev_irrev_ec50*c(0.25, 1.2, 4), y=0.5, vjust=0, size=5, col=rev_irrev_col, 
  ...
  annotate("text", x=1E-4, y=1.2, vjust=1, hjust=0, size=5,
...
```{r ksyn_keg_kRL_plots, fig.height=11, fig.width=9}
