...
The file was converted to the GML format, and manually edited with the yEd software. The output is stored in GraphML format, and exported as PDF and PNG files.
