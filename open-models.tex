...
\node[species, fill=green!20, right=1cm of RCI] (RLCI) {R$\cdot$L};
\node[species, fill=green!20, right=1cm of RLCI] (inactRLCI) {R-L};
...
\node[species, fill=green!20, right=1cm of R2] (RL2) {R$\cdot$L};
\node[species, fill=green!20, right=1cm of RL2] (RL2I) {R-L};
